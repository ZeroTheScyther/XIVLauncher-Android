...
public class VulkanRenderer implements WindowManager.OnWindowModificationListener,
    ...
    /** xla: Snapdragon Game Super Resolution 1 (window.frag applySGSR). */
    ...
    public void setVulkanXrFrameBridge(VulkanXrFrameBridge xrFrameBridge) {
        // GameNative gates this on its XR build flag; this app has no XR build.
        if (true) return;
    ...
    private Drawable createRootCursorDrawable() {
        try {
            ...
            Bitmap bitmap = com.winlator.core.CursorRes.decode(options);
